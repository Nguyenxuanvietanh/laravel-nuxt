...
<template>
  <div class="container">
    <section>
      ...
      <div class="column">
        <div class="card">
          ...
          <div class="card-content">
            ...
            <div class="content has-text-centered">
              Basic Location: {{ trolley.basic_location }}
            </div>
            <div class="content has-text-centered">
              {{ trolley.size }}
            </div>
      ...
      <div class="buttons">
        <b-button type="is-primary" expanded @click="isCardModalActive = true"
          ...
          <div class="modal-card" style="width: auto">
            <header class="modal-card-head">
              <p class="modal-card-title">
                Update Location for {{ trolley.slug }}
              </p>
...
export default {
  ...
  async asyncData({ route, params, $axios }) {
    const trolley = await $axios.$get(
      `/api/current_location/` + route.params.slug
    );
